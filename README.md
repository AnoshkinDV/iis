...
git clone `<ссылка_на_репозиторий>`{=html} cd my_proj
...
.venv_my_proj`\Scripts`{=tex}`\activate`{=tex}
...
Файл requirements.txt содержит список зависимостей проекта и позволяет
установить их одной командой.

## Что такое виртуальное окружение

Виртуальное окружение --- это изолированная среда Python, позволяющая
устанавливать зависимости отдельно для каждого проекта.

## Как создать виртуальное окружение

python3 -m venv .venv_my_proj

## Для чего нужен разведочный анализ данных

EDA позволяет:

-   изучить структуру данных
-   выявить пропуски и выбросы
-   понять распределения признаков
-   выявить зависимости между признаками

## Типы графиков

Часто используемые графики:
